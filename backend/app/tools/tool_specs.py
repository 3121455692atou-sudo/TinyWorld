...
TOOL_SPECS: dict[str, ToolSpec] = {
    ...
    "call_community_meeting": ToolSpec("call_community_meeting", "召集社区会议", "在广场、营地、集市或布告栏发起一次公共讨论，可讨论安全、住房、食物、工作、犯罪率、互助、宪法或共同规则。参数 content 或 speech。", required_location_tags=["social", "notice"], time_cost_minutes=15, hard_effect_id="governance_meeting", event_importance=70, triggers_reaction=True, visibility="public"),
    "propose_social_rule": ToolSpec("propose_social_rule", "提出公共规则", "提出一条社区规则、宪法草案、互助约定或法律建议。它只是公开提议，不会自动变成硬规则；其他居民可以支持、反对、修改或无视。参数 content。", required_location_tags=["social", "notice"], time_cost_minutes=15, hard_effect_id="governance_proposal", event_importance=75, triggers_reaction=True, visibility="public"),
    "support_social_rule": ToolSpec("support_social_rule", "支持公共规则", "公开支持最近的某条公共规则/宪法/互助建议。参数 content 或 speech。", required_location_tags=["social", "notice"], time_cost_minutes=8, hard_effect_id="governance_support", event_importance=55, triggers_reaction=True, visibility="public"),
    "oppose_social_rule": ToolSpec("oppose_social_rule", "反对或修正规则", "公开反对、质疑或提出修改最近的某条公共规则/宪法/互助建议。参数 content 或 speech。", required_location_tags=["social", "notice"], time_cost_minutes=8, hard_effect_id="governance_oppose", event_importance=55, triggers_reaction=True, visibility="public"),
