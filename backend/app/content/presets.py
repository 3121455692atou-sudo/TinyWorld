...
def _werewolf_locations() -> list[dict]:
    return [
        {"location_id": "village_square", "name": "村庄广场", "description": "白天自由聊天和观察的主要场所，能收集言论、关系和可疑举动。", "neighbors": ["discussion_hall", "cafeteria", "hot_spring", "dormitory", "vending_machine"], "available_tools": ["look_around", "speak_to_nearby", "observe_visible_agent", "work_shift_cleaner", "work_shift_night_guard"], "tags": ["social", "open_view", "werewolf_day", "work"], "visibility_radius": 1},
        ...
        {"location_id": "cafeteria", "name": "村庄食堂", "description": "村庄里供应简单饭食和饮水，居民可以在这里吃饭、喝水和短暂交流。每天还会上几种不同的食物可以购买。", "neighbors": ["village_square", "vending_machine"], "available_tools": ["eat_food", "drink_water", "speak_to_nearby", "feed_visible_agent_meal", "work_shift_cafeteria", "work_shift_cook", "market_search_goods", "market_recommend_goods", "market_buy_goods", "eat_inventory_food"], "tags": ["food_service", "food", "water", "social", "work", "trade"], "visibility_radius": 1},
        {"location_id": "vending_machine", "name": "自动售货机", "description": "村庄广场旁的旧式自动售货机，只出售少量包装食物、饮料和日用品，不连接现代工作、金融或完整集市。", "neighbors": ["village_square", "cafeteria"], "available_tools": ["market_search_goods", "market_recommend_goods", "market_buy_goods", "eat_inventory_food"], "tags": ["trade", "food", "water", "vending_machine", "werewolf_vending"], "visibility_radius": 0},
