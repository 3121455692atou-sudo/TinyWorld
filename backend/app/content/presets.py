...
def _werewolf_locations() -> list[dict]:
    return [
        ...
        {"location_id": "cafeteria", "name": "村庄食堂", "description": "村庄里供应简单饭食和饮水，居民可以在这里吃饭、喝水和短暂交流。", "neighbors": ["village_square", "vending_machine"], "available_tools": ["eat_food", "drink_water", "speak_to_nearby", "feed_visible_agent_meal", "work_shift_cafeteria", "work_shift_cook"], "tags": ["food_service", "food", "water", "social", "work"], "visibility_radius": 1},
