...
INITIAL_LOCATIONS: list[LocationSpec] = [
    LocationSpec(
        ...
        ["look_around", "speak_to_nearby", "play_simple_game", "work_shift_cleaner", "work_shift_night_guard"],
        0,
    ...
    LocationSpec(
        ...
        ["eat_food", "drink_water", "speak_to_nearby", "feed_visible_agent_meal", "work_shift_cafeteria", "work_shift_cook"],
        tags=["food_service", "food", "water", "social", "work"],
    ),
    LocationSpec(
        "cabin",
        "林间小屋",
        ...
        ["sleep", "rest", "wash", "drink_water", "write_diary", "work_shift_cleaner"],
    ...
    LocationSpec(
        ...
        ["write_diary", "add_memory", "tell_story_nearby", "work_shift_cleaner"],
        tags=["quiet", "learning"],
    ),
    LocationSpec(
        "lake",
        ...
        ["walk_by_lake", "rest", "speak_to_nearby", "work_shift_cleaner"],
    ...
    LocationSpec(
        ...
        ["library", "market"],
        ["craft_simple_item", "add_memory", "work_shift_cleaner"],
        tags=["craft", "work"],
    ),
    LocationSpec(
        "medical_room",
        ...
        ["cafeteria", "garden"],
        ["rest", "drink_water", "seek_help", "medical_checkup", "buy_nutrition_infusion", "free_medical_wash", "treat_visible_agent_medical", "feed_visible_agent_meal", "escort_visible_agent_to_medical", "work_shift_cleaner"],
        tags=["medical", "water", "quiet", "work"],
    ),
    LocationSpec(
        "garden",
        "花园",
        ...
        ["forage_food", "walk_by_lake", "play_simple_game", "work_shift_cleaner"],
    ...
    LocationSpec(
        ...
        ["give_item_to_visible_agent", "pick_up_item", "speak_to_nearby", "work_shift_cleaner", "work_shift_night_guard"],
        tags=["trade", "social"],
    ),
    LocationSpec(
        "hot_spring_lobby",
        ...
        ["speak_to_nearby", "invite_visible_agent_to_hot_spring", "work_shift_cleaner"],
    ...
    LocationSpec(
        ...
        ["hot_spring_lobby"],
        ["soak_hot_spring", "wash", "speak_to_nearby", "work_shift_cleaner"],
    ...
    LocationSpec(
        ...
        ["cabin", "lake"],
        ["tell_story_nearby", "sing_nearby", "play_simple_game", "work_shift_night_guard"],
        tags=["social", "fun", "night", "work"],
    ),
    LocationSpec(
        "notice_board",
        "布告栏",
        ...
        ["post_notice", "add_memory", "work_shift_cleaner", "work_shift_night_guard"],
